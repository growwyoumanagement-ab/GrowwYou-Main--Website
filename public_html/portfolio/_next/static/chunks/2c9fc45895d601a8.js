                                            ...
                                            case s.FetchStrategy.LoadingBoundary:
                                                {
                                                                    ...
                                                                    case s.FetchStrategy.LoadingBoundary:
                                                                        {
                                                                            ...
                                                                            }(t, r, n, u, null, i) : (0, o.convertRouteTreeToFlightRouterState)(u);h[l] = e;
                                                                            break
                                                                        }
                                                                    case s.FetchStrategy.PPRRuntime:
                                                                        {
                                                                            let e = x(t, r, n, u, !1, i, c);h[l] = e;
                                                                            break
                                                                        }
                                                                    case s.FetchStrategy.Full:
                                                                        {
                                                    ...
                                                    return n.size > 0 && j((0, o.fetchSegmentPrefetchesUsingDynamicRequest)(t, r, c, l, n)),
                                                    2
                                                }
                                        }
                                    }
    ...
    function h(e, t, r) {
        ...
        if (null !== d) switch (d.status) {
            ...
            case u.EntryStatus.Pending:
                {
                    let e = (0, u.waitForSegmentCacheEntry)(d);o = e.then(e => null !== e ? e.rsc : null),
                ...
                case i.NavigationResultTag.NoOp:
                    {
                        ...
                        return t.pathname === e.pathname && t.search === e.search && t.hash !== e.hash && (n.onlyHashChange = !0, n.shouldScroll = a.data.shouldScroll, n.hashFragment = t.hash, n.scrollableSegments = []),
