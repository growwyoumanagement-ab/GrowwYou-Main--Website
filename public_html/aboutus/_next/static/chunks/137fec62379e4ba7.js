(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 689554, e => {
    "use strict";
    var t = e.i(843476),
        r = e.i(271645),
        n = (e, t, r, n, s, a, o, l) => {
            ...
            function m(t) {
                ...
                }), r = t, l && c.includes(r) && (i.style.colorScheme = r)
            }
            if (n) m(n);
            else try {
        ...
        i = e => r.useContext(l) ? r.createElement(r.Fragment, null, e.children) : r.createElement(m, { ...e
        }),
        c = ["light", "dark"],
        m = ({
            forcedTheme: e,
            ...
            let [T, S] = r.useState(() => u(i, f)), [C, E] = r.useState(() => "system" === T ? y() : T), k = g ? Object.values(g) : m, A = r.useCallback(e => {
                let r = e;
                if (!r) return;
                "system" === e && n && (r = y());
                let a = g ? g[r] : r,
                    ...
                    c = e => {
                        "class" === e ? (i.classList.remove(...k), a && i.classList.add(a)) : e.startsWith("data-") && (a ? i.setAttribute(e, a) : i.removeAttribute(e))
                    };
            ...
            r.useEffect(() => {
                ...
                let e = e => {
                    e.key === i && (e.newValue ? S(e.newValue) : L(f))
                };
        ...
        d = r.memo(({
            ...
            let u = JSON.stringify([s, t, l, e, c, i, a, o]).slice(1, -1);
            return r.createElement("script", { ...d,
